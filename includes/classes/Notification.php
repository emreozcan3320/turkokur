...
class Notification {
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		switch($type) {
			case 'comment':
				$message = $userLoggedInName . " gönderine yorum yaptı.";
				break;
			case 'like':
				$message = $userLoggedInName . " gönderini begendi.";
				break;
			case 'profile_post':
				$message = $userLoggedInName . " profilinde gönderi paylaştı.";
				break;
			case 'comment_non_owner':
				$message = $userLoggedInName . " yorum yaptıgın gönderiye yorum yaptı.";
				break;
			case 'profile_comment':
				$message = $userLoggedInName . " profilinde ki gönderiye yorum yaptı.";
				break;
		}
