...
<body>
	...
	* {
	...
	<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
		...
		<input type="submit" name="postComment<?php echo $post_id; ?>" value="Gönderi">
	</form>
	...
	if($count != 0) {
		...
		while($comment = mysqli_fetch_array($get_comments)) {
			...
			if($interval->y >= 1) {
				if($interval == 1)
					$time_message = $interval->y . " sene önce"; //1 sene önce
				else
					$time_message = $interval->y . " sene önce"; //1+ sene önce
			}
		...
		echo "<center><br><br>Gösterilecek Daha Fazla Yorum Yok!</center>";
	}
